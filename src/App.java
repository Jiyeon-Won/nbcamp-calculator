...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            if (select == '1') {
                calculateCircleArea(sc, new CircleCalculator(new ArrayList<>()));
            }
            if (select == '2') {
    ...
    private static void calculateArithmetic (Scanner sc, ArithmeticCalculator cal2) throws Exception {
        ...
        switch (operation) {
            case '+' -> cal2.calculate(num1, num2, new AddOperator());
            case '-' -> cal2.calculate(num1, num2, new SubtractOperator());
            case '*' -> cal2.calculate(num1, num2, new MultiplyOperator());
            case '/' -> cal2.calculate(num1, num2, new DivideOperator());
            case '%' -> cal2.calculate(num1, num2, new ModOperator());
        }
